...
$fotoUsuario = !empty($usuario['Foto'] ?? $usuario['foto'] ?? '') ? ($usuario['Foto'] ?? $usuario['foto']) : 'https://via.placeholder.com/150/14181f/FFD700?text=User';
...
<header class="topo">
    ...
    <div class="usuario-topo">
        <img src="<?= htmlspecialchars($fotoUsuario); ?>" alt="Avatar">
        <span><?= htmlspecialchars($nomeUsuario); ?></span>
        <a href="tela_inicial.php" class="logout">Voltar</a>
    </div>
</header>
...
<section class="perfil">
    <div class="perfil-img-container">
        <img src="<?= htmlspecialchars($fotoUsuario); ?>" alt="Foto Perfil">
    </div>
    <div class="info">
        <h1><?= htmlspecialchars($nomeUsuario); ?></h1>
        <p>Email: <?= htmlspecialchars($emailUsuario); ?></p>
        <span class="badge">Membro VIP</span>
    </div>
</section>
