...
// Verifica se a coluna Nome_Exibicao existe (cria caso não exista para evitar erros)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['atualizar_perfil'])) {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            $mensagem = "<div class='erro'>Erro ao atualizar perfil. Tente outro e-mail.</div>";
        }
        $stmt->close();
    }
}
...
========================================================= */
$stmtDados = $conexao->prepare("SELECT Nome, Nome_Exibicao, Email, Nivel_Acesso FROM usuario WHERE ID_usuario = ?");
