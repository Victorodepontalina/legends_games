...
$sqlJogos = "SELECT ID_jogo, Nome, Preco_Unitario, Capa FROM jogo ORDER BY ID_jogo DESC";
$resultado = $conn->query($sqlJogos);
$jogos_banco = [];
...
.auth button { padding: 10px 20px; border: 0; border-radius: 10px; font-weight: bold; cursor: pointer; }
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form method="post">
                        ...
                        <button class="add" name="adicionar">🛒 Adicionar ao carrinho</button>
                    </form>
                </div>
            </div>
        <?php } } else { echo "<p>Nenhum jogo encontrado no banco.</p>"; } ?>
    </div>
</main>
</div>
